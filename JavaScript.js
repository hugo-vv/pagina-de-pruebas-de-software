    ...
    function Aumentar_Puntos() {
        ...
        if (Puntaje == 5) {
            ...
            Swal.fire({
                ...
                html: 'Al parecer nos salvamos, agradecemos tu ayuda y tu esfuerzo al superar este nivel, esperamos seguir contando contigo, si algo mas sucede y por cierto, no olvides que te esperan grandes cosas al final del juego asi que no pares de intentar ',
                icon: 'sucess',
...
function DETENER_JUEGO() {
    ...
    function PAUSE() { //Colocar la funcion de pausa y reanudar
        ...
        if (Activo == 1) {
            ...
            clearInterval(Restar_Tiempo)
            clearInterval(Restar_Puntaje)
                //BORRAMOS LA FUNCION DE TIEMPO
            document.getElementById("Tiempo").innerHTML = Tiempo
            clearInterval(Reanudar_trayectoria2)
            clearInterval(Reanudar_trayectoria)
